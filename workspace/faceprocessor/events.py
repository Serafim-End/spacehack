...
model = gensim.models.KeyedVectors.load_word2vec_format('/root/in_relaiton/web_0_300_20.bin.gz', binary=True)
...
# load it again
with open('/root/in_relaiton/pca_model.pkl', 'rb') as fid:
...
#     print basic
    ...
    return preprocessing.normalize(interests_vector)
